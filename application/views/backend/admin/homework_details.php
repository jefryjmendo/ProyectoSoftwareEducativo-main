                  ...
                  $homework_details = $this->db->get_where('deliveries', array('homework_code' => $homework_code))->result_array();
                   ...
                   ?>
                    <tr>
                      ...
                      <td width="7%">
                        <a class="btn btn-danger btn-sm" href="<?php echo base_url();?>admin/delete_delivery/<?php echo $row['id'];?>/<?php echo $homework_code;?>" onclick="return confirm('<?php echo get_phrase('confirm_delete');?>');"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="color:#fff"></i></a>
                      </td>
                    </tr>
                	<?php endforeach;?>
                  </tbody>
