                ...
                <div class="crumina-sticky-sidebar">
				    ...
				    <div class="widget w-create-fav-page">
					    ...
					    <div class="content">
						    ...
						    <a href="<?php echo base_url();?>student/progress/" class="btn btn-warning btn-sm"><?php echo get_phrase('go_to_my_timeline');?></a>
					    </div>
				    </div>
			    </div>
                        <div class="ui-block paddingtel" >
                        ...
                        <div class="today-events calendar ">
                            <div class="today-events-thumb">
                                <div class="date">
                                    ...
                                    <div class="day-week"><?php echo get_phrase(date('l'));?></div>
                                    <div class="month-year" style="color:#FFF"><?php echo get_phrase(date('F'));?>, <?php echo date('Y');?>.</div>
                                </div>
                            </div>
                            <div class="list">
