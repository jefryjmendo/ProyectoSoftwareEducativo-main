			        ...
			        <div class="todo-app-w">
                        <div class="todo-content">
                            <h4 class="todo-content-header">
                                <i class="picons-thin-icon-thin-0729_student_degree_science_university_school_graduate"></i><span style='font-weight:bold;font-size:19px'><?php echo get_phrase('school_timeline');?> (<?php echo get_phrase('this_week');?>).</span>
                            </h4>
                            ...
                            ?>
                             <?php 
                                ...
                                $arrs = $this->crud_model->get_timeline($week_days[$i],$this->session->userdata('login_user_id'));
                             ?>
                                    ...
                                    <div class="tasks-list-w">
                                        <ul class="tasks-list">
                                            <?php 
                                                ...
                                                foreach($arrs as $row):
                                            ?>
                                                <li class="draggable-task <?php echo $this->crud_model->check_li_status($row['wall_type'],$row['homework_id'],$this->session->userdata('login_user_id'));?>">
                                                    <div class="todo-task">
                                                        <?php if($row['wall_type'] == 'exam'):?>
                                                            ...
                                                            ?>
                                                            <span data-container="body" data-content="<i class='picons-thin-icon-thin-0021_calendar_month_day_planner'></i> <?php echo date('d/m/Y', $row['date_end']);?>. <br><i class='picons-thin-icon-thin-0025_alarm_clock_ringer_time_morning'></i> <?php echo $row['time_end'];?>.<br><a style='margin-top:10px;color:#fff' class='badge badge-primary' href='<?php echo base_url();?>student/online_exams/<?php echo $redirect;?>/' target='_blank'><?php echo get_phrase('go_to_details');?></a>" data-placement="top" data-toggle="popover" title="" data-html="true" data-original-title="<?php echo $row['title'];?>"><i class="os-icon picons-thin-icon-thin-0207_list_checkbox_todo_done" title="<?php echo get_phrase('online_exam');?>"></i>  <?php echo $row['title'];?>. (<b><?php echo $subject_name;?></b>)</span>
                                                        <?php elseif($row['wall_type'] == 'homework'):?>
                                                            <?php 
                                                                ...
                                                                $subject_name = $this->db->get_where('subject', array('subject_id' => $subject_id))->row()->name;
                                                            ?>
                                                            <span data-container="body" data-content="<i class='picons-thin-icon-thin-0021_calendar_month_day_planner'></i> <?php echo $row['date_end'];?>.<br><i class='picons-thin-icon-thin-0025_alarm_clock_ringer_time_morning'></i> <?php echo $row['time_end'];?>.<br><a style='margin-top:10px;color:#fff' class='badge badge-primary' href='<?php echo base_url();?>student/homeworkroom/<?php echo $redirect;?>/' target='_blank'><?php echo get_phrase('go_to_details');?></a>" data-placement="top" data-toggle="popover" title="" data-html="true" data-original-title="<?php echo $row['title'];?>"><i class="os-icon picons-thin-icon-thin-0004_pencil_ruler_drawing" title="<?php echo get_phrase('homework');?>"></i>  <?php echo $row['title'];?>. (<b><?php echo $subject_name;?></b>)</span>
                                                        <?php elseif($row['wall_type'] == 'forum'):?>
                                                            <?php 
                                                                ...
                                                                $subject_name = $this->db->get_where('subject', array('subject_id' => $subject_id))->row()->name;
                                                            ?>
                                                            <span data-container="body" data-content="<i class='picons-thin-icon-thin-0021_calendar_month_day_planner'></i> <?php echo $row['time_end'];?>.<br><a style='margin-top:10px;color:#fff' class='badge badge-primary' href='<?php echo base_url();?>student/forumroom/<?php echo $redirect;?>/' target='_blank'><?php echo get_phrase('go_to_details');?></a>" data-placement="top" data-toggle="popover" title="" data-html="true" data-original-title="<?php echo $row['title'];?>"><i class="os-icon picons-thin-icon-thin-0281_chat_message_discussion_bubble_reply_conversation" title="<?php echo get_phrase('forum');?>"></i>  <?php echo $row['title'];?>. (<b><?php echo $subject_name;?></b>)</span>
                                                        <?php elseif($row['wall_type'] == 'live'):?>
                                                            <?php 
                                                                ...
                                                                $subject_name = $this->db->get_where('subject', array('subject_id' => $subject_id))->row()->name;
                                                            ?>
                                                            <span data-container="body" data-content="<i class='picons-thin-icon-thin-0021_calendar_month_day_planner'></i> <?php echo $row['time_end'];?>.<br><i class='picons-thin-icon-thin-0025_alarm_clock_ringer_time_morning'></i> <?php echo $row['date_end'];?>.<br><a style='margin-top:10px;color:#fff' class='badge badge-primary' href='<?php echo base_url();?>student/meet/<?php echo $redirect;?>/' target='_blank'><?php echo get_phrase('go_to_details');?></a>" data-placement="top" data-toggle="popover" title="" data-html="true" data-original-title="<?php echo $row['title'];?>"><i class="os-icon picons-thin-icon-thin-0591_presentation_video_play_beamer" title="<?php echo get_phrase('live');?>"></i>  <?php echo $row['title'];?>. (<b><?php echo $subject_name;?></b>)</span>
                                                        <?php endif;?>
                                                    </div> 
                                                </li>
                                            <?php endforeach;?>
