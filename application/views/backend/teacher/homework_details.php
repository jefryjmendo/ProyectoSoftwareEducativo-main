                ...
                <table class="table table-lightborder">
                  <thead>
                    <tr>
                      ...
                      <th style="width:50px"><?php echo get_phrase('actions');?></th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php 
                   ...
                   ?>
                    <tr>
                      ...
                      <td>
                      	...
                      	<?php if($type == 2):?>
                        	<a class="btn btn-rounded btn-sm btn-primary"  onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_files/<?php echo $row['id'];?>');" href="javascript:void(0);" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo get_phrase('see_files');?></a>
                        <?php endif;?>
                      ...
                      <td width="7%">
                        <a class="btn btn-danger btn-sm" href="<?php echo base_url();?>teacher/delete_delivery/<?php echo $row['id'];?>/<?php echo $homework_code;?>" onclick="return confirm('<?php echo get_phrase('confirm_delete');?>');"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="color:#fff"></i></a>
                      </td>
                    </tr>
                	<?php endforeach;?>
                  </tbody>
