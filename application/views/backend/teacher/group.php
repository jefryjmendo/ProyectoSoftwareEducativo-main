                      				...
                      				<div class="user-w box <?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['group_message_thread_code']) echo 'active'; ?>">
                        				...
                        				<div class="user-info">
                          					...
                          					<div class="last-message">
                                                ...
                                                <a onClick="return confirm('<?php echo get_phrase('confirm_delete');?>')" href="<?php echo base_url();?>teacher/group/delete_group/<?php echo $row['group_message_thread_code'];?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="color:black;font-size:15px"></i>
                          					</div>
                        				</div>
                      				</div>
                      			</a>
