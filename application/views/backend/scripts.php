...
<?php if ($this->session->flashdata('flash_message') != ""):?>
    ...
    <script src='//cdn.jsdelivr.net/npm/fullcalendar@5.5.0/locales-all.js'></script>
    <script src="//cdnjs.cloudflare.com/ajax/libs/fullcalendar/2.6.1/lang-all.js"></script>
