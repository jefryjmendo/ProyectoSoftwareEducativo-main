      ...
      <legend><span>Verify Purchase</span></legend>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for=""> Username*</label><input class="form-control" placeholder="Enter any value!" required="" name="code_username" type="text">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="">Purchase Code*</label><input class="form-control" placeholder="Enter any value!" name="purchase_code" required="" required type="text">
                </div>
              </div>
            </div>
